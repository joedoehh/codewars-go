...
var _ = Describe("RGB conversion", func() {
	It("should test that the solution returns the correct value", func() {
		Expect(kata.RGB(0, 0, 0)).To(Equal("000000"))
		Expect(kata.RGB(1, 2, 3)).To(Equal("010203"))
		Expect(kata.RGB(255, 255, 255)).To(Equal("FFFFFF"))
		Expect(kata.RGB(254, 253, 252)).To(Equal("FEFDFC"))
		Expect(kata.RGB(-20, 275, 125)).To(Equal("00FF7D"))
	})
})
